...
-   In our GitHub Organization, click **Team** tab do find your team.
    Click **Members** tab located under the green button 'New Team' and from drop-down menu select **My teams**.
...
-   On GitHub, click on the green **Code** button, select **Use HTTPS** (this might already be selected by default).
...
-   Hit Create Project
-   In the right-down corner window click on the **Packages** tab and then click **renv** and from the drop-down menu select **Restore Library**
-   You're good to go!
...
Open the R Markdown (`lab.Rmd`) file in your project, change the author name to your name, and knit the document.
