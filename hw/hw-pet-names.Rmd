...
-   **Repository:** A Git repository contains all of your project's files and stores each file's revision history.
    ...
    -   All repos associated with this course are housed in the course GitHub organization.The organization is set up such that everyone from the group can see all repos, even those belonging to others.
...
The repo contains the starter documents, `lab.Rmd` and `hw.Rmd`, you will build upon when working on your assignment.
...
Before you start working with data you need to install all the needed packages
...
You will need to click on **New Project** --\> **Version Control** --\> **Git** --\> and paste the repo URL in the 'Repository URL' field.
...
Open the R Markdown (`hw.Rmd`) file in your project, change the author name to your name, and knit the document.
